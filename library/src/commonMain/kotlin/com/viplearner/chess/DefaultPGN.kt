...
class DefaultPGN
    ...
    constructor(
        ...
        override fun withTags(
            _tags: (Sequence<Map.Entry<String, String>>) -> Sequence<Map.Entry<String, String>>,
        ): DefaultPGN {
            val newTags =
                _tags(tags.entries.asSequence())
