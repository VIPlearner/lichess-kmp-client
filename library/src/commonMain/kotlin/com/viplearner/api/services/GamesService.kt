...
class GamesService(
     ...
     */
    suspend fun gamePgn(gameId: String, moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, literate: Boolean? = null, withBookmarked: Boolean? = null): Result<GameJson> {
        return try {
     ...
     */
    suspend fun userCurrentGame(username: String, moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, literate: Boolean? = null): Result<GameJson> {
        return try {
            val queryParams = mapOf(
                "moves" to moves,
                "pgnInJson" to pgnInJson,
     ...
     */
    suspend fun gamesUser(username: String, since: Int? = null, until: Int? = null, max: Int? = null, vs: String? = null, rated: Boolean? = null, perfType: String? = null, color: String? = null, analysed: Boolean? = null, moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, ongoing: Boolean? = null, finished: Boolean? = null, literate: Boolean? = null, lastFen: Boolean? = null, withBookmarked: Boolean? = null, sort: String? = null): Result<Flow<GameJson>> {
        return try {
            val queryParams = mapOf(
                "since" to since,
                "until" to until,
            ...
            val result: Flow<GameJson> = apiClient.safeGet("api/games/user/${username}", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     * Games are sorted by reverse chronological order (most recent first)
     */
    suspend fun gamesExportIds(moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, literate: Boolean? = null, body: String): Result<Flow<GameJson>> {
        return try {
            val queryParams = mapOf(
                "moves" to moves,
                "pgnInJson" to pgnInJson,
            ...
            val result: Flow<GameJson> = apiClient.safePost("api/games/export/_ids", queryParams, body)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun gamesByUsers(withCurrentGames: Boolean? = null, body: String): Result<Flow<GameStream>> {
        return try {
            val queryParams = mapOf(
                "withCurrentGames" to withCurrentGames
            ).filterValues { it != null }
            val result: Flow<GameStream> = apiClient.safePost("api/stream/games-by-users", queryParams, body)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun gamesByIds(streamId: String, body: String): Result<Flow<GameStream>> {
        return try {
            val result: Flow<GameStream> = apiClient.safePost("api/stream/games/${streamId}", body = body)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun gamesByIdsAdd(streamId: String, body: String): Result<Ok> {
        return try {
    ...
    suspend fun streamGame(id: String): Result<Flow<MoveStream>> {
        return try {
            val result: Flow<MoveStream> = apiClient.safeGet("api/stream/game/${id}")
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
    ...
    suspend fun importedGamesUser(): Result<String> {
        return try {
            val result: String = apiClient.safeGet("api/games/export/imports")
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     * Games are sorted by reverse chronological order (most recent first).
     */
    suspend fun exportBookmarks(since: Int? = null, until: Int? = null, max: Int? = null, moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, literate: Boolean? = null, lastFen: Boolean? = null, sort: String? = null): Result<Flow<GameJson>> {
        return try {
            val queryParams = mapOf(
                "since" to since,
                "until" to until,
            ...
            val result: Flow<GameJson> = apiClient.safeGet("api/games/export/bookmarks", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
