...
import com.viplearner.api.models.StudyImportPgnChapters
import com.viplearner.api.models.StudyMetadata
...
class StudiesService(
    ...
    suspend fun studyChapterPgn(
        ...
        return try {
            ...
            val result: String = apiClient.safeGetPgn("api/study/$studyId/$chapterId.pgn", queryParams)
     ...
     * If authenticated, then all public, unlisted, and private study chapters are read.
     */
    suspend fun studyAllChaptersPgn(
        studyId: String,
        clocks: Boolean? = null,
        comments: Boolean? = null,
        variations: Boolean? = null,
        ...
        return try {
            ...
            val result: String = apiClient.safeGetPgn("api/study/$studyId.pgn", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
    ...
    suspend fun studyExportAllPgn(
        ...
        return try {
            ...
            val result: String = apiClient.safeGetPgn("study/by/$username/export.pgn", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
    ...
    suspend fun studyListMetadata(username: String): Result<Flow<StudyMetadata>> {
        return try {
            val result: Flow<StudyMetadata> = apiClient.safeNdjsonGet("api/study/by/$username")
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun studyStudyIdChapterIdDelete(
        studyId: String,
        chapterId: String,
    ): Result<Unit> {
        return try {
