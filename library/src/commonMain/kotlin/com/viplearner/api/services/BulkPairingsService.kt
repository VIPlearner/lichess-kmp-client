...
class BulkPairingsService(
     ...
     */
    suspend fun bulkPairingCreate(players: String? = null, clockLimit: Int? = null, clockIncrement: Int? = null, days: Int? = null, pairAt: Int? = null, startClocksAt: Int? = null, rated: Boolean? = null, variant: String? = null, fen: String? = null, message: String? = null, rules: String? = null): Result<BulkPairing> {
        return try {
            val formBody = mapOf(
                "players" to players,
     ...
     */
    suspend fun bulkPairingIdGamesGet(id: String, moves: Boolean? = null, pgnInJson: Boolean? = null, tags: Boolean? = null, clocks: Boolean? = null, evals: Boolean? = null, accuracy: Boolean? = null, opening: Boolean? = null, division: Boolean? = null, literate: Boolean? = null): Result<Flow<GameJson>> {
        return try {
            ...
            val result: Flow<GameJson> = apiClient.safeGet("api/bulk-pairing/${id}/games", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
