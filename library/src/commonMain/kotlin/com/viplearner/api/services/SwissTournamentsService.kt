...
import com.viplearner.api.models.ResultsbyswissResponse
import com.viplearner.api.models.SwissTournament
...
class SwissTournamentsService(
    ...
    suspend fun swissNew(
        ...
        nbRounds: Int,
        startsAt: Int? = null,
        roundInterval: Int? = null,
        variant: String? = null,
        position: String? = null,
        description: String? = null,
        rated: Boolean? = null,
        password: String? = null,
        forbiddenPairings: String? = null,
        manualPairings: String? = null,
        chatFor: Int? = null,
        conditionsMinratingRating: Int? = null,
        conditionsMaxratingRating: Int? = null,
        conditionsNbratedgameNb: Int? = null,
        conditionsPlayyourgames: Boolean? = null,
     ...
     */
    suspend fun swiss(id: String): Result<SwissTournament> {
        return try {
     ...
     */
    suspend fun swissScheduleNextRound(
        id: String,
        date: Int? = null,
    ): Result<Unit> {
        return try {
    ...
    suspend fun gamesBySwiss(
        ...
        return try {
            ...
            val result: Flow<GameJson> = apiClient.safeNdjsonGet("api/swiss/$id/games", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun resultsBySwiss(
        id: String,
        nb: Int? = null,
    ): Result<Flow<ResultsbyswissResponse>> {
        return try {
            val queryParams =
                mapOf(
                    "nb" to nb,
                ).filterValues { it != null }
            val result: Flow<ResultsbyswissResponse> = apiClient.safeNdjsonGet("api/swiss/$id/results", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
