...
class ChallengesService(
     ...
     */
    suspend fun challengeStartClocks(
        gameId: String,
        token1: String,
        token2: String? = null,
    ): Result<Ok> {
     ...
     */
    suspend fun adminChallengeTokens(
        users: String,
        description: String,
        ...
        return try {
            ...
            val result: Map<String, String> = apiClient.safePost("api/token/admin-challenge", body = formBody)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
