...
class ArenaTournamentsService(
    ...
    suspend fun tournamentPost(
        ...
        berserkable: Boolean? = null,
        streakable: Boolean? = null,
        hasChat: Boolean? = null,
        description: String? = null,
        password: String? = null,
        teamBattleByTeam: String? = null,
        conditionsTeammemberTeamid: String? = null,
        conditionsMinratingRating: Int? = null,
        conditionsMaxratingRating: Int? = null,
        conditionsNbratedgameNb: Int? = null,
        conditionsAllowlist: String? = null,
        conditionsBots: Boolean? = null,
        conditionsAccountage: Int? = null,
     ...
     */
    suspend fun tournamentTeamBattlePost(
        id: String,
        teams: String,
        nbLeaders: Int,
    ): Result<ArenaTournamentFull> {
    ...
    suspend fun gamesByTournament(
        ...
        return try {
            ...
            val result: Flow<GameJson> = apiClient.safeNdjsonGet("api/tournament/$id/games", queryParams)
            Result.success(result)
        } catch (e: Exception) {
            Result.failure(e)
        }
     ...
     */
    suspend fun resultsByTournament(
        id: String,
        nb: Int? = null,
        sheet: Boolean? = null,
    ): Result<Flow<ResultsbytournamentResponse>> {
        return try {
            val queryParams =
                mapOf(
                    "nb" to nb,
            ...
            val result: Flow<ResultsbytournamentResponse> =
                apiClient.safeNdjsonGet(
     ...
     */
    suspend fun userNameTournamentCreated(
        username: String,
        nb: Int? = null,
        status: Int? = null,
        ...
        return try {
            ...
            val result: Flow<ArenaTournament> =
                apiClient.safeNdjsonGet(
     ...
     */
    suspend fun userNameTournamentPlayed(
        username: String,
        nb: Int? = null,
        performance: Boolean? = null,
    ): Result<Flow<ArenaTournamentPlayed>> {
        return try {
            val queryParams =
                mapOf(
                    "nb" to nb,
            ...
            val result: Flow<ArenaTournamentPlayed> =
                apiClient.safeNdjsonGet(
